...
template<typename PlainObjectType, int Options_, template <class> class MakePointer_> class TensorMap : public TensorBase<TensorMap<PlainObjectType, Options_, MakePointer_> >
{
  public:
   ...
   typedef typename internal::traits<PlainObjectType>::StorageKind StorageKind;
    ...
    EIGEN_STRONG_INLINE TensorMap(StoragePointerType dataPtr, std::initializer_list<int> firstDimension, IndexTypes... otherDimensions) : m_data(dataPtr), m_dimensions(firstDimension, otherDimensions...) {
      // The number of dimensions used to construct a tensor must be equal to the rank of the tensor.
