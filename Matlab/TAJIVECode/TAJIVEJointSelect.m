function row_joint = TAJIVEJointSelect(M, angleBound, vecr, iC, threp, rj, dataname, ...
...
%    Copyright (c) Meilei Jiang, Qing Feng, Jan Hannig & J. S. Marron 2017
    ...
    randSSVs = RandDirSSVMJ(n, vecr(iC,:), 100);
    ...
    if iplot == 1
        ...
        DiagPlotSSVMJ(dataname, vecr(iC,:), randSSVs, s_M, WedinSSVbds, 10, ...
        ...
        if nb == 2
            ...
            DiagPlotAngleMJ(dataname, vecr(iC,:), randAngles, pangles, WedinAnglebds, ...
